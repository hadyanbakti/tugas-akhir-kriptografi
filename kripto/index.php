...
<body>
  ...
  <nav class="navbar navbar-expand-lg bg-body-tertiary px-5 py-2 fs-5" style="background-color: #e3f2fd; box-shadow: 0px 8px 25px rgba(0,0,0,0.4); z-index: 1; position: fixed; width: 100%;">
    <div class="container-fluid justify-content-between">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div>
        <a href="./cekpembayaran.php" class="btn btn-outline-primary border-0" id="cek_pembayaran">cek pembayaran</a>
      ...
      <div class="container-fluid p-0">
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav fs-5 mb-4 gap-2">
            <a class="nav-link active ps-0" aria-current="page" href="./index.php">All</a>
            <a class="nav-link" href="./index.php?kategori=1">Perfume</a>
            <a class="nav-link cek" href="./index.php?kategori=2">Skincare</a>
            <a class="nav-link" href="./index.php?kategori=3">Makeup</a>
          </div>
        </div>
      </div>
    </nav>
  ...
  <div class="d-flex flex-column gap-2" style="position: fixed; right: 0; bottom: 0; z-index: 2; margin-right: 32px; margin-bottom: 50px;">
    <a href="keranjang.php">
      <div class="d-flex justify-content-center align-items-center" style="width: 60px; Height: 60px; background-color: #316CF4; border-radius: 50%;" id="animasi">
